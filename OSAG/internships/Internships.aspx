<%@ Page Title="" Language="C#" MasterPageFile="~/templates/Jobs.Master" AutoEventWireup="true" CodeBehind="Internships.aspx.cs" Inherits="OSAG.internships.Internships" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:GridView ID="grdvwInternships" 
        ...
        <asp:SqlDataSource ID="sqlsrc" runat="server"  
            ...
            SelectCommand="SELECT j.InternshipName, c.CompanyName FROM Internship j LEFT JOIN Company c on j.CompanyID = c.CompanyID"></asp:SqlDataSource>  
</asp:Content>
